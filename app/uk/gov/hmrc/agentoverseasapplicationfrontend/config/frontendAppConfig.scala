...
class FrontendAppConfig @Inject()(servicesConfig: ServicesConfig, environment: Environment) extends AppConfig {
  ...
  override val sessionCacheDomain: String = servicesConfig.getString("microservice.services.cachable.session-cache.domain")
  ...
  override val agentServicesAccountPath: String = servicesConfig.getString("microservice.services.agent-services-account.root-path")
