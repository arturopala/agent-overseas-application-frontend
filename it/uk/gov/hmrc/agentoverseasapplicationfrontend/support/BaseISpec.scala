...
import uk.gov.hmrc.agentoverseasapplicationfrontend.stubs.AuthStubs
import uk.gov.hmrc.http.HeaderCarrier
import uk.gov.hmrc.play.HeaderCarrierConverter

class BaseISpec extends UnitSpec with OneAppPerSuite with WireMockSupport with AuthStubs with MetricsTestSupport {
